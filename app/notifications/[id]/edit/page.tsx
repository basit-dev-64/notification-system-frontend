...
export default function EditNotificationPage() {
  ...
  const loadNotification = async () => {
    try {
      setFetching(true);
      const notification = await apiClient.getNotification(notificationId);
      setFormData({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await apiClient.updateNotification(notificationId, {
        type: formData.type,
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">Edit Notification</h1>
